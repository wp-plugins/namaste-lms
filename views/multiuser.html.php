	...
	<form method="post">
		...
		<?php if(!empty($_POST['role_key'])):
			...
			<p><label><?php _e('Assignments access:', 'namaste')?></label> <select name="homework_access">
				...
				<option value="no" <?php if(!empty($settings['homework_access']) and $settings['homework_access'] == 'no') echo "selected"?>><?php _e('No access to manage assignments','watupro')?></option>
			</select></p>
			...
			<p><label><?php _e('Students page access:', 'namaste')?></label> <select name="students_access">
				...
				<option value="no" <?php if(!empty($settings['students_access']) and $settings['students_access'] == 'no') echo "selected"?>><?php _e('No access to students page','watupro')?></option>
			</select></p>
