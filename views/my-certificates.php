...
<div class="wrap">
	<table class="widefat">
		...
		<?php foreach($certificates as $certificate):
			...
			<tr class="<?php echo $class?>"><td><a href="admin.php?page=namaste_view_certificate&id=<?php echo $certificate->id?>&student_id=<?php echo $student_id?>&noheader=1&my_id=<?php echo $certificate->my_id?>" target="_blank"><?php echo $certificate->title?></a></td>
