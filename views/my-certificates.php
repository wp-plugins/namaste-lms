...
<div class="wrap">
	<table class="widefat">
		...
		<?php foreach($certificates as $certificate):
			...
			<tr class="<?php echo $class?>"><td><a href="<?php echo site_url("?namaste_view_certificate=1&id=".$certificate->id."&student_id=".$student_id."&noheader=1&my_id=".$certificate->my_id)?>" target="_blank"><?php echo $certificate->title?></a></td>
