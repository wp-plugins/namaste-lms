...
class NamasteLMSMultiUser {
	static function manage() {
		...
		if(!empty($_POST['config_role'])) {
			...
			$role_settings[$_POST['role_key']] = array("homework_access" => $_POST['homework_access'], 
				"certificates_access" => $_POST['certificates_access'], "settings_access" => $_POST['settings_access'],
				"students_access" => $_POST['students_access'], "gradebook_access" => $_POST['gradebook_access']);
